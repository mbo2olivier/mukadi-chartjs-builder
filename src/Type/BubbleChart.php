...
class BubbleChart extends Chart {
    ...
    {
        parent::__construct(ChartView::BUBBLE, $builder);
        $this->datasets = [];
    }
    ...
    public function end(DatasetConfigurator $config): Chart
    {
        ...
        if ($count != 3) {
            throw new \InvalidArgumentException(sprintf('three data keys expected , %d found', $count));
        }
